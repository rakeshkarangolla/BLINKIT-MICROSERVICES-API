 ...
 * <br>order-service does not issue tokens; it only verifies them. The signing
 ...
 * product-service / cart-service use to verify. This shared-secret model lets
 * every microservice independently authenticate a caller without contacting
 ...
 * forwarded verbatim by CartServiceClient and ProductServiceClient when
 * order-service calls those services on behalf of the user.
 *
